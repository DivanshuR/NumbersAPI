...
public class MathActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final TextView math_mTextView = (TextView) findViewById(R.id.text);
        final EditText math_mEditText = (EditText) findViewById(R.id.edit);
        final Button math_button = (Button) findViewById(R.id.button);
        ...
        math_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final String editTextValue = math_mEditText.getText().toString();
                    ...
                    StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
                            new Response.Listener<String>() {
                                ...
                                public void onResponse(String response) {
                                    ...
                                    math_mTextView.setText(response);
                                }
                            }, new Response.ErrorListener() {
                        @Override
                        public void onErrorResponse(VolleyError error) {
                            math_mTextView.setText("Uh oh, we don't understand that or Check your connection :( ");
                        }
                    });
