...
public class DateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final TextView date_mTextView = (TextView) findViewById(R.id.text);
        final EditText date_mEditText = (EditText) findViewById(R.id.edit);
        final Button date_button = (Button) findViewById(R.id.button);

        date_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                final String editTextValue = date_mEditText.getText().toString();
                    ...
                    StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
                            new Response.Listener<String>() {
                                ...
                                public void onResponse(String response) {
                                    ...
                                    date_mTextView.setText(response);
                                }
                            }, new Response.ErrorListener() {
                        @Override
                        public void onErrorResponse(VolleyError error) {
                            date_mTextView.setText("Uh oh, we don't understand that or Check your connection :( ");
                        }
                    });
